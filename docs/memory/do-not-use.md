...
## Tombstone: Full memory in AGENTS.md, CLAUDE.md, or GEMINI.md
Do not copy full project memory into AGENTS.md, CLAUDE.md, GEMINI.md, or similar files. They should stay thin bootstraps.
