...
Installation and update workflows may use the distribution channel selected by
the user, such as a plugin marketplace, package index, or Git repository.

MemoryCustodian reads or modifies files only through the permissions granted to
